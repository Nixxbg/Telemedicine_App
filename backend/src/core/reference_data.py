...
LEGACY_PATIENT_TOKEN = "patient_jwt_token_here"
VALID_DOCTOR_TOKEN = "valid_doctor_jwt_token_here"
LEGACY_DOCTOR_TOKEN = "doctor_jwt_token_here"
...
STATIC_ACCESS_TOKENS: dict[str, tuple[UUID, UserType]] = {
    ...
    LEGACY_PATIENT_TOKEN: (PATIENT_USER_ID, UserType.PATIENT),
    VALID_DOCTOR_TOKEN: (DOCTOR_USER_ID, UserType.DOCTOR),
    LEGACY_DOCTOR_TOKEN: (DOCTOR_USER_ID, UserType.DOCTOR),
